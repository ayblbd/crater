...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="footer">
            <p>
            {{ $invoice->customer->company->name }}, {{ $invoice->customer->company->address->address_street_1 }}
            <br>
            N° du registre commercial: {{ $rc }} - ICE : {{ $ice }} - Taxe professionelle : {{ $tp }} - Idenfiant fiscal : {{ $if }} - Patente : {{ $patent }}
            </p>
        </div>
